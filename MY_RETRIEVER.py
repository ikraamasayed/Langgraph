...
#Chroma Vector DB
persist_directory = r"E:\Ikrama_projects\Python\LangGraph_Project\chroma_db"

collection_name = 'stock_marktet'
...
try:
    ...
    #Here ,we actually create thee chroma db using our embeddings model
    ...
    print(f"PERSISTED DIR :{persist_directory}")
